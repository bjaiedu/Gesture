namespace Gesture {
    ...
    enum GestureState {
        ...
        APDS9960_Forward = 0x05, /**< Gesture Forward*/
        apds9960_Backward = 0x06,/**< Gesture Backward*/
    }
    class enable {
        PON: number = 1;
        AEN: number = 1;
    ...
    class APDS9960 {
        ...
        private write8(reg: number, value: number): void {
            let buf: Buffer = pins.createBuffer(pins.sizeOf(NumberFormat.UInt8BE));
            buf.setNumber(NumberFormat.UInt8BE, 0, value);
            pins.i2cWriteBuffer(reg, buf, false);
        }
